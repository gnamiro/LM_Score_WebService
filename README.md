...
### Remember, for using the pars-bert model, you need to clone the model from [https://huggingface.co/HooshvareLab/bert-base-parsbert-uncased](hugging face) website to your working directory. To speed up server performance, it is better to clone it first rather than downloading the model with the help of the transformers library.
